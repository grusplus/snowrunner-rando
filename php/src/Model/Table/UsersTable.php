...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('username')
            ->requirePresence('username', 'create', "You need a username")
            ->notEmpty(['username'], 'Hello');

        $validator
            ->scalar('password')
            ->requirePresence('password', 'create', "You need a password")
            ->notEmpty('password');
    ...
    {
        $rules->add($rules->isUnique(['username'], 'unique username please'));
